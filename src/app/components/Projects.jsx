  ...
  const [projects] = useState([
    {
      ...
      image: "/project1.jpg", // You can add project images to your public folder
    ...
    },
    {
      ...
      description: "A real-time chat application with AI-powered responses using OpenAI's GPT model.",
      date: "February 2024",
    ...
    },
    {
      ...
      description: "A weather dashboard that displays current weather and forecasts using a weather API. Features location detection and interactive maps.",
      date: "December 2023",
      githubLink: "https://github.com/yourusername/weather-dashboard",
      image: "/project5.jpg",
      technologies: ["React", "JavaScript", "CSS", "Weather API", "Leaflet Maps"]
    },
    {
      id: 6,
      title: "Fitness Tracker",
      description: "A mobile-first fitness tracking application that allows users to log workouts, track progress, and set fitness goals.",
      date: "November 2023",
          ...
          {projects.map((project) => (
            ...
            >
              <div className="relative h-48 w-full">
                {/* You can add actual project images later */}
